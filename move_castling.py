...
class Chess:
    ...
    def make_move(self, move):
        if move:
            ...
            if self.moving_figure.lower() == 'k' and move in self.castling_d:
                ...
                if vertical[move[0]] > vertical[move[2]]:
                    self.matrix[horizontal[move[1]]][vertical['a']] = '.'
                    self.matrix[horizontal[move[1]]][vertical['d']] = rook

                if vertical[move[0]] < vertical[move[2]]:
                    self.matrix[horizontal[move[1]]][vertical['h']] = '.'
                    self.matrix[horizontal[move[1]]][vertical['f']] = rook
    ...
    def pawn_turn (self,move):
        ...
        self.matrix[horizontal[move[3]]][vertical[move[2]]] = self.moving_figure
